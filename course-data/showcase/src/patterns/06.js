...
const ClapCount = ({ count, setRef, refKey, ...restProps }) => (
  <span
    ref={setRef}
    data-refkey={refKey}
...
const CountTotal = ({ countTotal, setRef, refKey, ...restProps }) => (
  <span
    ref={setRef}
    data-refkey={refKey}
  ...
  return (
    ...
    >
      ...
      <ClapCount
        count={count}
        setRef={setRef}
        refKey={DOM_REF_KEYS.CLAP_COUNT_REF}
      />
      <CountTotal
        countTotal={countTotal}
        setRef={setRef}
        refKey={DOM_REF_KEYS.CLAP_COUNT_TOTAL_REF}
      />
    </button>
  );
};
